<div>
    ...
    <div class="container card " id="alta">
        ...
        <form wire:submit.prevent="submit">
            ...
            <div class="mb-3"> <!-- precio -->
                <div class="row">
                    ...
                    <div class="col-3">
                        <input class="form-control" placeholder="Precio" name="precio" step="any" type="number" id="precio"
            ...
            <div class="mb-3">
                <div class="row">
                    ...
                    <div class="col-3">
                        ...
                        {{-- <button class="btn btn-primary" wire:click="grabarArticulos">Guardar Datos</button> --}}
                    </div>
                </div>
            </div>
